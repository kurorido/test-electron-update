...
const release = 'https://api.github.com/repos/kurorido/test-electron-update/releases/latest'
const downloadUrl = 'https://github.com/kurorido/test-electron-update/releases/latest'
